...
class LoginDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.login_reject.setGeometry(151, 90, 75, 24)
        ...
        verticalLayout.addWidget(self.user_label)
        verticalLayout.addWidget(self.pass_label)
        ...
        verticalLayout_2.addWidget(self.user_input)
        verticalLayout_2.addWidget(self.pass_input)
